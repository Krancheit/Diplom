/*************************************************************************
  ...
  Modified
    ...
    12-Aug-15 Larionov V.       Changes
    17-Sep-14 Larionov V.       Fixes
    05-Sep-13 Larionov V.       Total changes
    20-Nov-12 Larionov V.       Fixes
    16-Oct-12 Larionov V.       Spectrum trend saving
    18-Mar-09 Yurovskiy         Cosmetics
    22-May-07 Yurovskiy         Modifications for displaying external trend & AR trend
    06-May-07 Yurovskiy         External trend with any index (0-100) included
    29-Mar-07 Yurovskiy         GetStateInPoint() fixed
    14-Feb-07 Yurovskiy         SEF calculations fixed & modified
    29-Jan-07 Yurovskiy         Artifact indication is set for CSA trend also
    26-Jan-07 Yurovskiy         Displaying of background higher than SEF for CSA trend added
    18-Jan-07 Yurovskiy         Spc & SpcStat buffer modified; Set() modified
    08-Dec-06 Yurovskiy         Fixes
    05-Dec-06 Yurovskiy         Modifications for the trend of AR ratio
    23-Oct-06 Yurovskiy         new fields for SEF added to trMcSTBPrmCSA; calculation of SEF modified
    12-Oct-06 Yurovskiy         GetValue() removed, GetStateInPoint() added
    10-Oct-06 Yurovskiy         colors for signal out of boards are made mixed in rel. amp. trend
    13-Sep-06 Yurovskiy         container is eredited from base container class in Mc_cashedBuffer.*
    07-Sep-06 Yurovskiy         displaying of trends fixed
    02-Sep-06 Yurovskiy         many modifications; container for bitmap buffers written
    09-Aug-06 Yurovskiy         1-dim. trends modified & fixed
    04-Aug-06 Yurovskiy         spectr. stat. buffer: new features, included in bitmap buffer,
                                bitmap buffer for rel. amplitude added
    28-Jul-06 Yurovskiy         buffer for values of SEF & energy of bands in pixels' points added
    20-Jul-06 Yurovskiy         mean values fixed
    25-Jun-06 Yurovskiy         mean values of energy in given bands included; bitmap buffer modified
    23-Jun-06 Yurovskiy         interface with buffers modified
    28-Apr-06 Yurovskiy         nMaxSEFPt instead of nMaxPt
    30-Mar-06 Yurovskiy         Scale transformations added
    10-Mar-06 Yurovskiy         Calculation of fCurrMax fixed
    07-Mar-06 Yurovskiy         Interface  modified
    06-Mar-06 Yurovskiy         Displaying of max. & second peak fixed
